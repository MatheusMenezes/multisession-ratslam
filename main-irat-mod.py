...
def merge(slam1, slam2, vt_id1, vt_id2):
    ...
    print ('slam1::VISUAL_EXPERIENCES_SIZE: ' + str(slam1.map.experiences.size))
    print ('slam2::VISUAL_EXPERIENCES_SIZE: ' + str(slam2.map.experiences.size))

    print ('slam1::VISUAL_LINKS_SIZE: ' + str(slam1.map.links.size))
    print ('slam2::VISUAL_LINKS_SIZE: ' + str(slam2.map.links.size))
    ...
    # tempo atual do slam
    time_size   = slam2.map.accum_delta_time_s
    # deltas do mapa
    accumulate_deltas = []
    accumulate_deltas.append(slam2.map.accum_delta_x)
    accumulate_deltas.append(slam2.map.accum_delta_y)
    accumulate_deltas.append(slam2.map.accum_delta_facing)
    accumulate_deltas.append(time_size)
    ...
    # Aqui eu calculo os deltas pra cada coordenada dos pcexp. Se quiseres testar as ativacoes, descomente 
    ...
    #     link1 = slam1.map.links[vt_id1]
    #     link2 = slam2.map.links[vt_id2]

    #     link_delta_heading_rad  = clip_rad_180(link2.heading_rad - link1.heading_rad)
    #     link_delta_facing_rad   = clip_rad_180(link2.facing_rad - link1.facing_rad)

    #     # link_delta_heading_rad  = clip_rad_180(link2.heading_rad + exp_delta_th)
    #     # link_delta_facing_rad   = clip_rad_180(link2.facing_rad + exp_delta_th)
