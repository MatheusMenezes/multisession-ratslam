...
def RatSlam_by_load(mergeSlam , time_diff):
    ...
    # FOR ONLY SLAM WITH LOADED IMAGES AND ODOM =======
        ...
        # # Data format
        # name_repo_1   = '/home/matheus/data-ratslam/irat/irat-complete/'
        # odom_file_1   = name_repo_1 + 'irat-odom-complete.txt'
        ...
        slam2 = ratslam.Ratslam()
        slam2.load('/home/matheus/merge_ratslammodule/MAP_RatSlamModule/Saves/paper_irat_4')
